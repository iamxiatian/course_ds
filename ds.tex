...
\setCJKfamilyfont{Hei}{Source Han Sans Light}  
\newcommand{\cjkem}{\CJKfamily{Hei}}
\setCJKfamilyfont{Hei}{Source Han Sans Light}  
\setCJKmainfont{Source Han Sans Light} %方正字体，也可以改成：微软雅黑
\setCJKsansfont{Source Han Sans Light} 
