...
\begin{frame}[fragile]
  ...
  \scalebox{0.8}{
    \begin{tikzpicture}[ n/.style={minimum height=0.8cm, minimum width=1cm},
      ...
      \draw node[n2, draw, below=0.5 of jvexAC] (ivexAD) {0} node[n3, draw, right=0 of ivexAD] (ilinkAD) {} node[n2, draw, right=0 of ilinkAD] (jvexAD) {3} node[n3, draw, right=0 of jvexAD] (jlinkAD) {$\wedge$};
      ...
      \path[e] (jlinkAB.center) -- (ivexAC);
      \draw[e] (jlinkAC.center) to[out=270, in=0, ->] ++(-2, -0.6) to[out=180, in=180, ->] (ivexAD.west);
